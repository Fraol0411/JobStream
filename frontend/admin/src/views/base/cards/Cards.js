    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader style={{ textAlign: 'center' }}>Create New Fresh Graduate Vacancy</CCardHeader>
          <CCardBody>
            ...
            <CForm onSubmit={handleSubmit}>
              <CRow>
                <CCol md={6}>
                  ...
                  <CFormInput type="text" id="title" placeholder="Enter job title" value={jobDetails.title} onChange={handleChange} />
                </CCol>
                <CCol md={6}>
                  <CFormLabel htmlFor="department">Department</CFormLabel>
                  <CFormInput type="text" id="department" placeholder="Enter department" value={jobDetails.department} onChange={handleChange} />
                </CCol>
              </CRow>
              <CRow className="mt-3">
                <CCol md={6}>
                  <CFormLabel htmlFor="dutystation">Duty Station</CFormLabel>
                  <CFormInput type="text" id="dutystation" placeholder="Enter location" value={jobDetails.dutystation} onChange={handleChange} />
                </CCol>
              </CRow>
              <CRow className="mt-3">
                <CCol md={12}>
                  <CFormLabel htmlFor="description">Job Description</CFormLabel>
                  <CFormTextarea id="description" rows="4" placeholder="Enter job description" value={jobDetails.description} onChange={handleChange} />
                </CCol>
              </CRow>
              <CRow className="mt-3">
                <CCol md={12}>
                  <CFormLabel htmlFor="requirements">Job Requirements</CFormLabel>
                  <CFormTextarea id="requirements" rows="4" placeholder="Enter job requirements" value={jobDetails.requirements} onChange={handleChange} />
                </CCol>
              </CRow>
              <CRow className="mt-3">
                <CCol md={12}>
              ...
              <CRow className="mt-3">
                <CCol md={12}>
                  ...
                  <CFormTextarea id="responsibilities" rows="4" placeholder="Enter job responsibilities" value={jobDetails.responsibilities} onChange={handleChange} />
                </CCol>
              </CRow>
              <CRow className="mt-3">
                <CCol md={12}>
              ...
              <CRow className="mt-3">
                <CCol md={6}>
                  ...
                  <CFormInput type="text" id="contact" placeholder="Enter contact information" value={jobDetails.contact} onChange={handleChange} />
                </CCol>
              </CRow>
              <CRow className="mt-3">
                <CCol md={6}>
                  <CFormLabel htmlFor="deadline">Application Deadline</CFormLabel>
                  <CFormInput type="text" id="deadline" placeholder="Enter application deadline" value={jobDetails.deadline} onChange={handleChange} />
                </CCol>
              </CRow>
              <CRow className="mt-3">
